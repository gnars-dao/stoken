...
import { AddAccount, AddAccountAuthority, AddKeyAuthority, Broadcast, Convert, CreateClaimedAccount, CreateProposal, Custom, Decode, Delegation, Encode, Login, Post, PowerDown, PowerUp, Proxy, RecurrentTransfer, RemoveAccountAuthority, RemoveKeyAuthority, RemoveProposal, SendToken, SignBuffer, SignTx, Transfer, UpdateProposalVote, Vote, WitnessVote } from './interfaces/keychain-sdk.interface';
import { KeychainOptions, KeychainRequestResponse, KeychainSignTxRequestResponse } from './interfaces/keychain.interface';
/**
 * @description
 * KeychainSDK Class.
 ...
 * @class KeychainSDK
 */
export declare class KeychainSDK {
    window: Window;
     ...
     * @memberof KeychainSDK
     */
    encode: (data: Encode) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    decode: (data: Decode) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    signBuffer: (data: SignBuffer) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    addAccountAuthority: (data: AddAccountAuthority, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    removeAccountAuthority: (data: RemoveAccountAuthority, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    addKeyAuthority: (data: AddKeyAuthority, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    removeKeyAuthority: (data: RemoveKeyAuthority, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    broadcast: (data: Broadcast, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    signTx: (data: SignTx) => Promise<KeychainSignTxRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    signedCall: (data: ExcludeCommonParams<RequestSignedCall>, options: KeychainOptions) => Promise<string>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    post: (data: Post, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     * Requests a vote
     * @example
     ...
     * @memberof KeychainSDK
     */
    vote: (data: Vote, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    custom: (data: Custom, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     * Requests a transfer
     * @example
     ...
     * @memberof KeychainSDK
     */
    transfer: (data: Transfer, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    sendToken: (data: SendToken, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    delegation: (data: Delegation, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    witnessVote: (data: WitnessVote, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    proxy: (data: Proxy, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     * Request a power up
     * @example
     ...
     * @memberof KeychainSDK
     */
    powerUp: (data: PowerUp, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    powerDown: (data: PowerDown, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    createClaimedAccount: (data: CreateClaimedAccount, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    createProposal: (data: CreateProposal, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     ...
     * @param {KeychainOptions=} options
     */
    removeProposal: (data: RemoveProposal, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    updateProposalVote: (data: UpdateProposalVote, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    addAccount: (data: AddAccount) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    convert: (data: Convert, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
    /**
     * @description
     ...
     * @memberof KeychainSDK
     */
    recurrentTransfer: (data: RecurrentTransfer, options?: KeychainOptions) => Promise<KeychainRequestResponse>;
}
