...
export interface KeychainAddAccountRequestResponse extends Omit<KeychainRequestResponse, 'result'> {
    result: boolean;
}
export interface KeychainHiveEngineRequestResponse extends Omit<KeychainRequestResponse, 'result'> {
    result: HiveEngineTransactionResult;
}
export interface KeychainRequestStringResponse extends Omit<KeychainRequestResponse, 'result'> {
    result: string;
}
