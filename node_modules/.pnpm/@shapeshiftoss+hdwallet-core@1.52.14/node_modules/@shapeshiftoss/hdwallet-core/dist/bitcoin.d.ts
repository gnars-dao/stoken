...
export type BitcoinInput = GuardedUnion<(BitcoinInputBase & {
    coinbase: string;
}) | (BitcoinInputBase & {
...
export type BTCSignTxOutput = GuardedUnion<BTCSignTxOutputSpend | BTCSignTxOutputSpendP2PKH | BTCSignTxOutputSpendP2SH | BTCSignTxOutputSpendP2WPKH | BTCSignTxOutputTransfer | BTCSignTxOutputChange | BTCSignTxOutputMemo>;
...
export type BTCSignTxKK = Omit<BTCSignTx, "inputs"> & {
    inputs: Array<BTCSignTxInputKK>;
};
export type BTCSignTxNative = Omit<BTCSignTx, "inputs"> & {
    inputs: Array<BTCSignTxInputNative>;
};
export type BTCSignTxTrezor = Omit<BTCSignTx, "inputs"> & {
    inputs: Array<BTCSignTxInputTrezor>;
};
export type BTCSignTxLedger = Omit<BTCSignTx, "inputs"> & {
