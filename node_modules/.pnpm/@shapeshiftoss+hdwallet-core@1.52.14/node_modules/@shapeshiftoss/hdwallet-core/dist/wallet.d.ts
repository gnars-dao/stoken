...
export declare function supportsGnosis(wallet: HDWallet): wallet is ETHWallet;
export declare function supportsArbitrum(wallet: HDWallet): wallet is ETHWallet;
export declare function supportsArbitrumNova(wallet: HDWallet): wallet is ETHWallet;
export declare function infoCosmos(info: HDWalletInfo): info is CosmosWalletInfo;
export declare function supportsOsmosis(wallet: HDWallet): wallet is OsmosisWallet;
export declare function infoOsmosis(info: HDWalletInfo): info is OsmosisWalletInfo;
export declare function supportsArkeo(wallet: HDWallet): wallet is ArkeoWallet;
export declare function infoArkeo(info: HDWalletInfo): info is ArkeoWalletInfo;
