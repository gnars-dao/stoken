...
export declare function takeFirstOfManyEvents(eventEmitter: eventemitter2.EventEmitter2, events: string[]): Rx.Observable<object>;
...
declare const slip44Table: Readonly<{
    ...
    readonly Polygon: 60;
    readonly Gnosis: 60;
    readonly Arbitrum: 60;
    readonly ArbitrumNova: 60;
}>;
...
export declare function sortTxFields(obj: any): any;
export {};
