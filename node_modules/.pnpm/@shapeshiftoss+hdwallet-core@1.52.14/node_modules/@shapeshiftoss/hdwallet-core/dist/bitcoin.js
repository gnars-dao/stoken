...
})(BTCInputScriptType || (exports.BTCInputScriptType = BTCInputScriptType = {}));
...
})(BTCOutputScriptType || (exports.BTCOutputScriptType = BTCOutputScriptType = {}));
...
})(BTCOutputAddressType || (exports.BTCOutputAddressType = BTCOutputAddressType = {}));
function unknownUTXOPath(path, coin, scriptType) {
    return {
        verbose: (0, utils_1.addressNListToBIP32)(path),
        coin,
        scriptType,
        isKnown: false,
    };
...
function describeUTXOPath(path, coin, scriptType) {
    ...
    let isPrefork = false;
    const slip44 = (0, utils_1.slip44ByCoin)(coin);
    if (slip44 === undefined)
        return unknown;
    if (path[1] !== 0x80000000 + slip44) {
        switch (coin) {
            case "BitcoinCash":
            case "BitcoinGold": {
                if (path[1] === 0x80000000 + (0, utils_1.slip44ByCoin)("Bitcoin")) {
                    isPrefork = true;
                    break;
                }
                return unknown;
            ...
            case "BitcoinSV": {
                if (path[1] === 0x80000000 + (0, utils_1.slip44ByCoin)("Bitcoin") || path[1] === 0x80000000 + (0, utils_1.slip44ByCoin)("BitcoinCash")) {
                    isPrefork = true;
                    break;
                }
                return unknown;
