...
class NodeUsbTransport extends abstract_1.AbstractTransport {
    constructor(params) {
        ...
        this.init = resultEmpty_1.emptyAbortable;
        this.acquire = resultEmpty_1.emptyAbortable;
        this.enumerate = resultEmpty_1.emptyAbortable;
        this.call = resultEmpty_1.emptyAbortable;
        this.receive = resultEmpty_1.emptyAbortable;
        this.send = resultEmpty_1.emptyAbortable;
        this.release = resultEmpty_1.emptyAbortable;
