...
exports.MsgSetIPAddress = void 0;
/* eslint-disable */
var long_1 = __importDefault(require("long"));
var minimal_1 = __importDefault(require("protobufjs/minimal"));
function createBaseMsgSetIPAddress() {
    return { ipAddress: "", signer: new Uint8Array() };
}
exports.MsgSetIPAddress = {
    ...
    decode: function (input, length) {
        ...
        var message = createBaseMsgSetIPAddress();
    ...
    fromPartial: function (object) {
        var _a, _b;
        var message = createBaseMsgSetIPAddress();
        message.ipAddress = (_a = object.ipAddress) !== null && _a !== void 0 ? _a : "";
