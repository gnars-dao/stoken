...
declare type ConnectMethodNames = 'connectEVMWallet' | 'connectKeplr' | 'connectKeystore' | 'connectLedger' | 'connectOkx' | 'connectMetaMask' | 'connectKeepKey' | 'connectTrezor' | 'connectWalletconnect' | 'connectXDEFI';
