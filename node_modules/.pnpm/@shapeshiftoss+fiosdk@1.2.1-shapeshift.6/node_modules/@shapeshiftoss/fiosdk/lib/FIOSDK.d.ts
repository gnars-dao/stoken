...
import { AddPublicAddressResponse, CancelFundsRequestResponse, RemovePublicAddressesResponse, RemoveAllPublicAddressesResponse, BurnFioAddressResponse, TransferFioAddressResponse, TransferFioDomainResponse, AvailabilityResponse, BalanceResponse, FioFeeResponse, FioNamesResponse, PendingFioRequestsResponse, PublicAddressResponse, RecordObtDataResponse, RegisterFioAddressResponse, RegisterFioDomainResponse, RejectFundsResponse, RenewFioAddressResponse, RenewFioDomainResponse, RequestFundsResponse, SentFioRequestResponse, SetFioDomainVisibilityResponse, TransferTokensResponse, GetObtDataResponse, CancelledFioRequestResponse, FioAddressesResponse } from './entities/responses';
...
export declare class FIOSDK {
     ...
     */
    static derivedPublicKey(fioPrivateKey: PrivateKey): {
        publicKey: any;
    };
    /**
     ...
     */
    constructor(privateKey: PrivateKey, publicKey: string, baseUrl: string, fetchjson: FetchJson, registerMockUrl?: string, technologyProviderId?: string, returnPreparedTrx?: boolean);
    /**
