...
exports.saveLogLevel = exports.logger = exports.createLogger = exports.getLogLevel = void 0;
 ...
 */
const browserLoggerFn = (level, data) => {
    var _a;
    const consoleFn = level === logger_1.LogLevel.TRACE ? logger_1.LogLevel.DEBUG : level;
    const msg = data.error
        ? `Error [Kind: ${data.error.kind}] ${data.error.message} `
        : ((_a = data._messages) === null || _a === void 0 ? void 0 : _a.join(' ')) || data.message;
    // eslint-disable-next-line no-console
    console[consoleFn](`%c${logStyles[level].icon} ${level}: [${data.namespace}]%c${msg}`, logStyles[level].title, logStyles[level].message, data);
};
/**
...
const getLogLevel = () => {
    var _a, _b;
    try {
        return ((_b = (_a = globalThis.localStorage) === null || _a === void 0 ? void 0 : _a.getItem) === null || _b === void 0 ? void 0 : _b.call(_a, 'LOG_LEVEL')) || 'debug';
    }
    catch (e) {
        return 'debug';
    }
...
const createLogger = (opts) => {
    const options = Object.assign({ name: 'App', logFn: browserLoggerFn, level: (0, exports.getLogLevel)() }, opts);
    const l = new logger_1.Logger(options);
    l.debug({ options }, 'New Logger Created');
    return l;
};
exports.createLogger = createLogger;
const LogLevelStrings = Object.values(logger_1.LogLevel);
 ...
 */
const saveLogLevel = (level) => {
    var _a, _b;
    if (isValidLogLevel(level)) {
        try {
            (_b = (_a = globalThis.localStorage) === null || _a === void 0 ? void 0 : _a.setItem) === null || _b === void 0 ? void 0 : _b.call(_a, 'LOG_LEVEL', level);
            return true;
        }
        catch (e) {
            exports.logger.error(e, { fn: 'saveLogLevel', level }, 'Error persisting LOG_LEVEL to LocalStorage');
        }
    }
    return false;
};
exports.saveLogLevel = saveLogLevel;
/*
 DOCUMENTATION
