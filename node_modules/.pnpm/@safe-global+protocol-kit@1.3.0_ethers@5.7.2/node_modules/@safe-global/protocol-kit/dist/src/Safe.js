...
class Safe {
    ...
    async getAddress() {
        if (__classPrivateFieldGet(this, _Safe_predictedSafe, "f")) {
            ...
            return (0, utils_1.predictSafeAddress)({
                ethAdapter: __classPrivateFieldGet(this, _Safe_ethAdapter, "f"),
                customContracts: __classPrivateFieldGet(this, _Safe_contractManager, "f").contractNetworks?.[chainId],
    ...
    async getEncodedTransaction(safeTransaction) {
        ...
        const customContracts = __classPrivateFieldGet(this, _Safe_contractManager, "f").contractNetworks?.[chainId];
    ...
    async createSafeDeploymentTransaction(customSaltNonce, transactionOptions) {
        ...
        const saltNonce = customSaltNonce || safeDeploymentConfig?.saltNonce || utils_1.PREDETERMINED_SALT_NONCE;
