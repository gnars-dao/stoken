            ...
            case 17:
              ...
              earningsDayData = labels.map(function (label) {
                ...
                var totalGain = strategies.map(function (strategy) {
                  return strategy.latestReport ? new BigNumber.BigNumber(strategy.latestReport.totalGain) : new BigNumber.BigNumber(0);
                }).reduce(function (sum, value) {
                  return sum.plus(value);
                });
                var totalLoss = strategies.map(function (strategy) {
                  return strategy.latestReport ? new BigNumber.BigNumber(strategy.latestReport.totalLoss) : new BigNumber.BigNumber(0);
                }).reduce(function (sum, value) {
                  return sum.plus(value);
                });
                var amountEarnt = totalGain.minus(totalLoss);
                var amountUsdc = priceUsdc.multipliedBy(amountEarnt).dividedBy(new BigNumber.BigNumber(10).pow(new BigNumber.BigNumber(data.vault.token.decimals)));
                var dayData = {
                  earnings: {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              return _context.abrupt("return", transfers.reduce(function (prev, current) {
                return prev.plus(new BigNumber__default(current.tokenAmountUsdc || 0));
              }, new BigNumber__default(0)).toFixed(0));
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              signer = this.ctx.provider.write.getSigner(from);
              zapProtocol = PickleJars.includes(toVault) ? exports.ZapProtocol.PICKLE : exports.ZapProtocol.YEARN;
              vaultContract = zapProtocol === exports.ZapProtocol.PICKLE ? new PickleJarContract(toVault, signer) : new YearnVaultContract(toVault, signer);
              _context2.next = 6;
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              isZapping = underlyingToken !== address.getAddress(toToken);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              signer = this.ctx.provider.write.getSigner(from);
              tokenContract = new contracts.Contract(token, TokenAbi, signer);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              contract = new contracts.Contract(token, TokenAbi, signer);
              _context6.next = 4;
            ...
            case 4:
              ...
              return _context6.abrupt("return", new BigNumber__default(result.toString()).lt(new BigNumber__default(amount)));
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 9:
              ...
              targetUnderlyingTokensReceived = new BigNumber__default(tokensReceived).div(new BigNumber__default(10).pow(decimals)).multipliedBy(pricePerShare).toFixed(0);
              result = {
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 5:
              ...
              value = new BigNumber__default(zapInParams.value).toFixed(0);
            ...
            case 14:
              ...
              _context8.next = _context8.t0 === exports.ZapProtocol.YEARN ? 21 : _context8.t0 === exports.ZapProtocol.PICKLE ? 25 : 29;
              break;

            case 21:
              _context8.next = 23;
              return this.yearn.services.oracle.getNormalizedValueUsdc(toVault, tokensReceived).then(function (price) {
                return new BigNumber__default(price);
              })["catch"](function () {
                throw new PriceFetchingError("error fetching price", PriceFetchingError.FETCHING_PRICE_ORACLE);
              });
            ...
            case 25:
              ...
              return this.yearn.services.pickle.getPriceUsdc(toVault)["catch"](function () {
                ...
                return new BigNumber__default(usdc);
              });

            case 27:
              amountReceivedUsdc = _context8.sent.dividedBy(new BigNumber__default(10).pow(decimals)).multipliedBy(new BigNumber__default(tokensReceived));
              return _context8.abrupt("break", 29);

            case 29:
              oracleToken = sellToken === EthAddress ? WethAddress : sellToken;
              _context8.t1 = BigNumber__default;
              _context8.next = 33;
            ...
            case 33:
              ...
              conversionRate = amountReceivedUsdc.div(new BigNumber__default(zapInAmountUsdc)).toNumber();
              result = {
                sourceTokenAddress: sellToken,
                sourceTokenAmount: amount,
        ...
        while (1) {
          switch (_context11.prev = _context11.next) {
                  ...
                  while (1) {
                    switch (_context10.prev = _context10.next) {
                      ...
                      case 3:
                        ...
                        return _context10.abrupt("return", new BigNumber__default(response.transaction.transaction_info.call_trace.output).toFixed(0));
            ...
            case 16:
              ...
              conversionRate = new BigNumber__default(zapOutAmountUsdc).div(new BigNumber__default(soldAssetAmountUsdc)).toNumber();
              result = {
                sourceTokenAddress: fromVault,
                sourceTokenAmount: amount,
                targetTokenAddress: toToken,
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 2:
              ...
              tokenContract = new contracts.Contract(token, TokenAbi$1, signer);
              _context6.next = 7;
            ...
            case 11:
              ...
              gasPriceFastGwei = new BigNumber__default(gasPrice.fast).times(new BigNumber__default(Math.pow(10, 9)));
              zapProtocol = PickleJars.includes(vault.address) ? exports.ZapProtocol.PICKLE : exports.ZapProtocol.YEARN;
              _context6.next = 16;
        ...
        while (1) {
          switch (_context17.prev = _context17.next) {
            case 0:
              ...
              return _context17.abrupt("return", this.zapIn(vault, token, amount, account, options, exports.ZapProtocol.PICKLE, overrides));
            ...
            case 20:
              return _context17.abrupt("return", this.zapIn(vault, token, amount, account, options, exports.ZapProtocol.YEARN, overrides));
        ...
        while (1) {
          switch (_context19.prev = _context19.next) {
            ...
            case 17:
              ...
              return _context19.abrupt("return", this.executeZapperTransaction(transactionRequest, overrides, bignumber.BigNumber.from(zapOutParams.gasPrice)));
        ...
        while (1) {
          switch (_context20.prev = _context20.next) {
            ...
            case 7:
              ...
              return _context20.abrupt("return", this.executeZapperTransaction(transactionRequest, overrides, bignumber.BigNumber.from(zapInParams.gasPrice)));
          ...
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return _context.abrupt("return", tokens.map(function (token) {
                var address$1 = token.address === ZeroAddress ? EthAddress : address.getAddress(String(token.address));
