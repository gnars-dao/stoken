...
module.exports = /** @class */ (function () {
    function wallet(spec, config) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, this.pioneerApi.instance.Online()];
                        case 2:
                            result = _a.sent();
        ...
        this.invoke = function (invocation) {
            return __awaiter(this, void 0, void 0, function () {
                var tag, invocationId, msg, request, result, e_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            tag = TAG + " | invoke | ";
                        ...
                        case 1:
                            ...
                            if (!invocation.type)
                                throw Error("invocation Type required!");
                            if (!invocation.context)
                                throw Error("invocation Context required!");
                            //create invocationId
                            if (!invocation.invocationId) {
                                invocation.invocationId = "pioneer:invocation:v0.01:" + invocation.network + ":" + short.generate();
                            }
                            invocationId = invocation.invocationId;
                            msg = JSON.stringify(invocation);
                            ...
                            return [4 /*yield*/, this.pioneerApi.instance.Invoke(null, request)
