...
function isExternalPrivateKey(x) {
...
exports.isExternalPrivateKey = isExternalPrivateKey;
    ...
    function JsSignatureProvider(privateKeys) {
        ...
        try {
            for (var privateKeys_1 = __values(privateKeys), privateKeys_1_1 = privateKeys_1.next(); !privateKeys_1_1.done; privateKeys_1_1 = privateKeys_1.next()) {
                ...
                var pub = chain_numeric_1.convertLegacyPublicKey(isExternalPrivateKey(k) ? k.publicKey : ecc.PrivateKey.fromString(k).toPublic().toString());
                this.keys.set(pub, k);
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            if (!isExternalPrivateKey(priv)) return [3 /*break*/, 2];
                                            return [4 /*yield*/, priv.sign(signBuf)];
                                        case 1: return [2 /*return*/, _a.sent()];
                                        case 2: return [2 /*return*/, ecc.Signature.sign(signBuf, priv).toString()];
                                    }
                                });
                            }); }))];
                    case 1:
