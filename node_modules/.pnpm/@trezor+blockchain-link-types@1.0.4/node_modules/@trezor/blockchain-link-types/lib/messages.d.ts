...
}> | ChannelMessage<Connect> | ChannelMessage<Disconnect> | ChannelMessage<GetInfo> | ChannelMessage<GetBlockHash> | ChannelMessage<GetBlock> | ChannelMessage<GetAccountInfo> | ChannelMessage<GetAccountUtxo> | ChannelMessage<GetTransaction> | ChannelMessage<GetCurrentFiatRates> | ChannelMessage<GetFiatRatesForTimestamps> | ChannelMessage<GetAccountBalanceHistory> | ChannelMessage<GetFiatRatesTickersList> | ChannelMessage<EstimateFee> | ChannelMessage<Subscribe> | ChannelMessage<Unsubscribe> | ChannelMessage<PushTransaction>;
