...
export declare type Arg1 = unknown | Arg2;
export declare type Arg2 = Record<string, unknown> | Arg3;
export declare type Arg3 = string;
/**
 * Calls to the logger are strictly typed and arguments must be passed in a specific order
 * "message" is always last
 */
export declare type LoggerMethod = ((arg1: Arg1, arg2?: Arg2, arg3?: Arg3) => void) | ((message: string) => void) | ((fields: Record<string, unknown>, message: string) => void) | ((e: unknown, fields: Record<string, unknown>, message: string) => void) | ((e: unknown, message: string) => void);
...
export declare type LoggerT = LoggerMethods & LoggerExtended;
 ...
 */
export declare type LoggerFunction = (level: Exclude<LogLevel, LogLevel.NONE>, data: LogData) => void;
