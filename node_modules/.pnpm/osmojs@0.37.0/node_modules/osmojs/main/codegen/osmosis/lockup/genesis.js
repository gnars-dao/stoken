...
function createBaseGenesisState() {
  return {
    lastLockId: _helpers.Long.UZERO,
    locks: [],
    syntheticLocks: []
  };
}
...
var GenesisState = {
  encode: function encode(message) {
    ...
    var _iterator = _createForOfIteratorHelper(message.locks),
        _step;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        _lock.PeriodLock.encode(v, writer.uint32(18).fork()).ldelim();
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
    ...
    var _iterator2 = _createForOfIteratorHelper(message.syntheticLocks),
        _step2;
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        _lock.SyntheticLock.encode(_v, writer.uint32(26).fork()).ldelim();
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
  ...
  fromPartial: function fromPartial(object) {
    ...
    var message = createBaseGenesisState();
    message.lastLockId = object.lastLockId !== undefined && object.lastLockId !== null ? _helpers.Long.fromValue(object.lastLockId) : _helpers.Long.UZERO;
