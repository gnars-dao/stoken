    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 26:
            _context.t15 = _context.sent.MsgClientImpl;
            _context.t16 = rpc;
          ...
          case 32:
            _context.t19 = _context.sent.MsgClientImpl;
            _context.t20 = rpc;
          ...
          case 38:
            _context.t23 = _context.sent.MsgClientImpl;
            _context.t24 = rpc;
            ...
            _context.t27 = {
              ...
              upgrade: _context.t26
            };
            _context.next = 45;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./gamm/pool-models/balancer/tx/tx.rpc.msg"));
            });
          ...
          case 45:
            ...
            _context.next = 51;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./gamm/pool-models/stableswap/tx.rpc.msg"));
            });
          ...
          case 51:
            ...
            _context.t36 = {
              balancer: _context.t31,
              stableswap: _context.t35
            };
            _context.next = 58;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./gamm/v1beta1/tx.rpc.msg"));
            });

          case 58:
            _context.t37 = _context.sent.MsgClientImpl;
            _context.t38 = rpc;
            _context.t39 = new _context.t37(_context.t38);
            _context.t40 = {
              poolmodels: _context.t36,
              v1beta1: _context.t39
            };
            _context.next = 64;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./incentives/tx.rpc.msg"));
            });
          ...
          case 64:
            ...
            _context.next = 69;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./lockup/tx.rpc.msg"));
            });

          case 69:
            _context.t44 = _context.sent.MsgClientImpl;
            _context.t45 = rpc;
            _context.t46 = new _context.t44(_context.t45);
            _context.next = 74;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./streamswap/v1/tx.rpc.msg"));
            });
          ...
          case 74:
            ...
            _context.next = 80;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./superfluid/tx.rpc.msg"));
            });
          ...
          case 80:
            ...
            _context.next = 85;
            return Promise.resolve().then(function () {
              return _interopRequireWildcard(require("./tokenfactory/v1beta1/tx.rpc.msg"));
            });
          ...
          case 85:
            ...
            _context.t57 = {
              v1beta1: _context.t56
            };
            _context.t58 = {
              gamm: _context.t40,
              incentives: _context.t43,
              lockup: _context.t46,
              streamswap: _context.t50,
              superfluid: _context.t53,
              tokenfactory: _context.t57
            };
            return _context.abrupt("return", {
              cosmos: _context.t27,
              osmosis: _context.t58
            });
