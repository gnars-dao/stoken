...
(function (_tendermint) {
  const abci = _tendermint.abci = _objectSpread({}, _128);

  const crypto = _tendermint.crypto = _objectSpread(_objectSpread({}, _129), _130);

  let libs;

  (function (_libs) {
    const bits = _libs.bits = _objectSpread({}, _131);
  })(libs || (libs = _tendermint.libs || (_tendermint.libs = {})));

  const p2p = _tendermint.p2p = _objectSpread({}, _132);

  const types = _tendermint.types = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, _133), _134), _135), _136), _137);

  const version = _tendermint.version = _objectSpread({}, _138);
