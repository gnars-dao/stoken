...
exports.buildMessage = exports.getKeyPair = void 0;
...
function buildMessage(message) {
    const messageBytes = typeof message === "string" && !ethers_1.ethers.utils.isHexString(message)
        ? ethers_1.ethers.utils.toUtf8Bytes(message)
        : ethers_1.ethers.utils.arrayify(message);
