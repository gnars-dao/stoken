...
function getKeyPair(masterKey, addressNList) {
    return __awaiter(this, void 0, void 0, function* () {
        const out = yield addressNList.reduce((a, x) => __awaiter(this, void 0, void 0, function* () { return (yield a).derive(x); }), Promise.resolve(masterKey));
        if (!Isolation.Core.BIP32.nodeSupportsECDH(out))
            throw new Error("fio requires keys that implement ECDH");
        return yield Isolation.Adapters.FIO.create(out);
    });
}
...
function MixinNativeFioWallet(Base) {
    var _MixinNativeFioWallet_masterKey, _a;
    // eslint-disable-next-line @typescript-eslint/no-shadow
    return _a = class MixinNativeFioWallet extends Base {
            constructor() {
                ...
                _MixinNativeFioWallet_masterKey.set(this, void 0);
            }
            fioInitializeWallet(masterKey) {
                return __awaiter(this, void 0, void 0, function* () {
                    __classPrivateFieldSet(this, _MixinNativeFioWallet_masterKey, masterKey, "f");
                });
            }
            fioWipe() {
                __classPrivateFieldSet(this, _MixinNativeFioWallet_masterKey, undefined, "f");
            }
            getFioSdk(addressNList) {
                return __awaiter(this, void 0, void 0, function* () {
                    return this.needsMnemonic(!!__classPrivateFieldGet(this, _MixinNativeFioWallet_masterKey, "f"), () => __awaiter(this, void 0, void 0, function* () {
                        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                        const key = yield getKeyPair(__classPrivateFieldGet(this, _MixinNativeFioWallet_masterKey, "f"), addressNList);
            ...
            fioGetAddress(msg) {
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    return (_b = sdk === null || sdk === void 0 ? void 0 : sdk.getFioPublicKey()) !== null && _b !== void 0 ? _b : null;
                });
            }
            fioSignTx(msg) {
                return __awaiter(this, void 0, void 0, function* () {
            ...
            fioEncryptRequestContent(msg) {
                return __awaiter(this, void 0, void 0, function* () {
                    return this.needsMnemonic(!!__classPrivateFieldGet(this, _MixinNativeFioWallet_masterKey, "f"), () => __awaiter(this, void 0, void 0, function* () {
                        // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                        const privateKey = yield getKeyPair(__classPrivateFieldGet(this, _MixinNativeFioWallet_masterKey, "f"), msg.addressNList);
        ...
        _MixinNativeFioWallet_masterKey = new WeakMap(),
        _a;
}
