...
class MetaMaskAdapter {
    ...
    pairDevice() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!provider.isBraveWallet && !(0, metamask_snaps_adapter_1.shapeShiftSnapInstalled)(common_1.SNAP_ID)) {
            ...
            try {
                yield ((_a = provider.request) === null || _a === void 0 ? void 0 : _a.call(provider, { method: "eth_requestAccounts" }));
            }
            catch (error) {
                console.error("Could not get MetaMask accounts. ");
                throw error;
            }
            const wallet = new shapeshift_multichain_1.MetaMaskShapeShiftMultiChainHDWallet(provider);
