...
import type { Account, BaseInfo, BaseTxHistoryTx, GasFees, SendTxBody, Tx } from '../models';
...
export declare class V1Api extends runtime.BaseAPI {
     ...
     */
    estimateGasRaw(requestParameters: EstimateGasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<string>>;
    /**
     * Get the estimated gas cost of a transaction
     */
    estimateGas(requestParameters: EstimateGasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<string>;
    /**
