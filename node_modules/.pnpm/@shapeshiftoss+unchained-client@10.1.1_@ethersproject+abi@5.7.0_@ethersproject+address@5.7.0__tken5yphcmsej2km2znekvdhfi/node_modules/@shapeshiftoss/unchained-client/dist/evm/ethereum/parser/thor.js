...
const thor_1 = __importDefault(require("./abi/thor"));
const constants_1 = require("./constants");
const SWAP_TYPES = ['SWAP', '=', 's'];
class Parser {
    constructor(args) {
        this.abiInterface = new ethers_1.ethers.utils.Interface(thor_1.default);
        ...
        this.routerContract = (() => {
            switch (args.chainId) {
                case 'eip155:1':
                    return constants_1.THOR_ROUTER_CONTRACT_MAINNET;
                case 'eip155:3':
                    return constants_1.THOR_ROUTER_CONTRACT_ROPSTEN;
                default:
