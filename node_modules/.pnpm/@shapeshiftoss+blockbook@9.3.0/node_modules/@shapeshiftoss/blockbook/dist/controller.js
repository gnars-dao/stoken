...
let Blockbook = class Blockbook extends tsoa_1.Controller {
    constructor(args = {
        ...
        (0, axios_retry_1.default)(this.instance, { shouldResetTimeout: true, retries, retryDelay: axios_retry_1.default.exponentialDelay });
    }
    /**
    ...
    async getInfo() {
        try {
            const { data } = await this.instance.get(`api/v2`);
            return data;
        }
        catch (err) {
            if (err instanceof axios_1.AxiosError || err instanceof Error) {
                throw new models_1.ApiError(err);
            }
            throw err;
        }
    }
    ...
    async getBlockHash(height) {
        try {
            const { data } = await this.instance.get(`api/v2/block-index/${height}`);
            return data;
        }
        catch (err) {
            if (err instanceof axios_1.AxiosError || err instanceof Error) {
    ...
    async getTransaction(txid) {
        try {
            const { data } = await this.instance.get(`api/v2/tx/${txid}`);
            return data;
        }
        catch (err) {
            if (err instanceof axios_1.AxiosError || err instanceof Error) {
     ...
     * @example address "0x37863DF4712e4494dFfc4854862259399354b2BB"
     */
    async getAddress(address, page, pageSize, from, to, details, contract) {
        try {
            const { data } = await this.instance.get(`api/v2/address/${address}`, {
                params: {
                    page,
                    pageSize,
                    from,
     ...
     * @example xpub "xpub6DQYbVJSVvJPzpYenir7zVSf2WPZRu69LxZuMezzAKuT6biPcug6Vw1zMk4knPBeNKvioutc4EGpPQ8cZiWtjcXYvJ6wPiwcGmCkihA9Jy3"
     */
    async getXpub(xpub, page, pageSize, from, to, details, tokens) {
        try {
            const { data } = await this.instance.get(`api/v2/xpub/${xpub}`, {
                params: {
                    page,
                    pageSize,
                    from,
     ...
     */
    async getUtxo(account, confirmed) {
        try {
            const { data } = await this.instance.get(`api/v2/utxo/${account}`, {
                params: {
                    confirmed,
                },
            });
     ...
     */
    async getBlock(block, page) {
        try {
            const { data } = await this.instance.get(`api/v2/block/${block}`, {
                params: {
                    page,
                },
            });
    ...
    async sendTransaction(hex) {
        try {
            const { data } = await this.instance.get(`api/v2/sendtx/${hex}`);
            return data;
        }
        catch (err) {
            if (err instanceof axios_1.AxiosError || err instanceof Error) {
     ...
     */
    async balanceHistory(account, from, to, fiatcurrency, groupBy) {
        try {
            const { data } = await this.instance.get(`api/v2/balancehistory/${account}`, {
                params: {
                    from,
                    to,
                    fiatcurrency,
...
__decorate([
    ...
    (0, tsoa_1.Get)('')
], Blockbook.prototype, "getInfo", null);
__decorate([
    (0, tsoa_1.Example)({
        hash: '0xac8e95f7483f7131261bcc0a70873f8236c27444c940defc677f74f281220193',
    }),
    (0, tsoa_1.Get)('block-index/{height}'),
    __param(0, (0, tsoa_1.Path)())
], Blockbook.prototype, "getBlockHash", null);
__decorate([
    (0, tsoa_1.Example)({
    ...
    __param(0, (0, tsoa_1.Path)())
], Blockbook.prototype, "getTransaction", null);
__decorate([
    (0, tsoa_1.Get)('tx-specific/{txid}'),
    __param(0, (0, tsoa_1.Path)())
], Blockbook.prototype, "getTransactionSpecific", null);
__decorate([
    (0, tsoa_1.Example)({
...
], Blockbook.prototype, "getAddress", null);
__decorate([
    (0, tsoa_1.Example)({
    ...
    __param(5, (0, tsoa_1.Query)()),
    __param(6, (0, tsoa_1.Query)())
], Blockbook.prototype, "getXpub", null);
__decorate([
    (0, tsoa_1.Example)([
        {
    ...
    (0, tsoa_1.Get)('utxo/{account}'),
    __param(0, (0, tsoa_1.Path)()),
    __param(1, (0, tsoa_1.Query)())
], Blockbook.prototype, "getUtxo", null);
__decorate([
    (0, tsoa_1.Example)({
        page: 1,
        totalPages: 1,
    ...
    (0, tsoa_1.Get)('block/{block}'),
    __param(0, (0, tsoa_1.Path)()),
    __param(1, (0, tsoa_1.Query)())
], Blockbook.prototype, "getBlock", null);
__decorate([
    (0, tsoa_1.Example)({
        result: '0x97d99bc7729211111a21b12c933c949d4f31684f1d6954ff477d0477538ff017',
    }),
    (0, tsoa_1.Get)('sendtx/{hex}'),
    __param(0, (0, tsoa_1.Path)())
], Blockbook.prototype, "sendTransaction", null);
__decorate([
    (0, tsoa_1.Example)([
        {
            time: 1602806400,
    ...
    (0, tsoa_1.Get)('balancehistory/{account}'),
    __param(0, (0, tsoa_1.Path)()),
    __param(1, (0, tsoa_1.Query)()),
    __param(2, (0, tsoa_1.Query)()),
    __param(3, (0, tsoa_1.Query)()),
    __param(4, (0, tsoa_1.Query)())
], Blockbook.prototype, "balanceHistory", null);
__decorate([
    (0, tsoa_1.Example)([
        {
            feePerTx: '23424',
    ...
    (0, tsoa_1.Get)('estimatefees'),
    __param(0, (0, tsoa_1.Query)())
], Blockbook.prototype, "estimateFees", null);
Blockbook = __decorate([
