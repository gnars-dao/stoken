...
const internet_computer_1 = __importDefault(require("./data/internet_computer"));
...
addTokens(internet_computer_1.default.map(convertICPTokens));
...
function convertSplTokens([chainId, name, symbol, address, decimals, enableCountervalues,]) {
...
function convertICPTokens([assetCode, assetIssuer, assetType, name, precision, enableCountervalues,]) {
    return {
        type: "TokenCurrency",
        id: `icp/asset/${assetCode}:${assetIssuer}`,
        contractAddress: assetIssuer,
        parentCurrency: (0, currencies_1.getCryptoCurrencyById)("internet_computer"),
        tokenType: assetType,
        name,
        ticker: assetCode,
        disableCountervalue: !enableCountervalues,
