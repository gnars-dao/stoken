...
import { Chain, ChainId, RPCUrl, WalletOption } from '@pioneer-platform/types';
...
const getToolbox = async ({
  ...
  switch (chain) {
    ...
    case Chain.Binance: {
      const { sortObject, BinanceToolbox } = await import('@pioneer-platform/toolbox-cosmos');
    ...
    const promises = chainsToConnect.map(async (chain) => {
      ...
      addChain({
        ...
        walletMethods: {
          ...toolbox,
          getAddress: () => address,
          getAccount: chain === Chain.THORChain ? getAccount : (toolbox as any),
        },
