...
var test_service = function () {
    return __awaiter(this, void 0, void 0, function () {
        var tag, wallet, username, balance, _a, _b, _c, _d, queryKey, config, app, events, eventPairReceived_1, seedChains, code, pairSuccess, user, blockchains, feeEstimate, txid, isConfirmed, txInfo, e_1;
        var _this = this;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 14:
                    ...
                    txid = "9d0e92caea91504263dba97c72699c179b0c1305e9fdff63a7e74242c50fbee2";
                    isConfirmed = false;
                    _e.label = 15;
                case 15:
                    if (!!isConfirmed) return [3 /*break*/, 18];
                    return [4 /*yield*/, user.clients.bitcoinCash.getTransactionData(txid)];
                case 16:
                    txInfo = _e.sent();
