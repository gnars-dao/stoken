...
var test_service = function () {
    return __awaiter(this, void 0, void 0, function () {
        var tag, wallet, username_1, balance, _a, _b, _c, _d, queryKey_1, config, app, events, eventPairReceived_1, seedChains, code, pairSuccess, user, blockchains, client, balanceSdk, address, sendPayload, txid, e_1;
        var _this = this;
                ...
                case 6:
                    ...
                    events.on('message', function (request) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            ...
                            assert(request.queryKey, queryKey_1);
                            assert(request.username, username_1);
                            assert(request.url, username_1);
