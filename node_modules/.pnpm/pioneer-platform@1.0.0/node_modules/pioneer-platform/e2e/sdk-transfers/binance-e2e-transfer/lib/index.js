...
var BLOCKCHAIN = 'binance';
var ASSET = 'BNB';
var MIN_BALANCE = process.env['MIN_BALANCE_BNB'] || 0.0002;
...
var test_service = function () {
    return __awaiter(this, void 0, void 0, function () {
        var tag, wallet, username, balance, _a, _b, _c, _d, queryKey, config, app, seedChains, code, pairSuccess, user, blockchains, address, sendPayload, txid, e_1;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 8:
                    ...
                    assert(pairSuccess);
                    return [4 /*yield*/, app.getUserParams()];
                case 9:
                    user = _e.sent();
                    log.info("user: ", user);
