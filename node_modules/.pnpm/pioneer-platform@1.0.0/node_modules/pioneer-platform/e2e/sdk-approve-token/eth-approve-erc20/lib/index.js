...
var ASSET = 'ETH';
var MIN_BALANCE = process.env['MIN_BALANCE_ETH'] || 0.0002;
var TEST_AMOUNT = process.env['TEST_AMOUNT'] || 0.0001;
var spec = process.env['URL_PIONEER_SPEC'];
var NO_BROADCAST = process.env['E2E_NO_BROADCAST'] || null;
var wss = process.env['URL_PIONEER_SOCKET'];
var test_service = function () {
    return __awaiter(this, void 0, void 0, function () {
        var tag, wallet, username, balance, _a, _b, _c, _d, queryKey, config, app, events, eventPairReceived_1, seedChains, code, pairSuccess, user, blockchains, client, balanceSdk, contract, tokenAddress, amountApprove_1, amount, isApproved, txid, e_1;
        var _this = this;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    ...
                    if (!(balance < MIN_BALANCE)) return [3 /*break*/, 4];
                    _b = (_a = log).error;
                    _c = [tag];
                    _d = " Test wallet low! amount: " + balance + " target: " + MIN_BALANCE + " Send moneies to " + ASSET + ": ";
                ...
                case 14:
                    ...
                    contract = "0x42A5Ed456650a09Dc10EBc6361A7480fDd61f27B";
                    tokenAddress = "0x6b3595068778dd592e39a122f4f5a5cf09c90fe2";
                    amountApprove_1 = 1000000000;
                    amount = {
                        amount: function () {
                            return BigNumber.BigNumber.from(amountApprove_1);
                        }
                    };
                    log.info(tag, "app: ", app);
                    return [4 /*yield*/, client.isApproved(contract, tokenAddress, amount)];
                case 15:
                    isApproved = _e.sent();
                    log.info("isApproved: ", isApproved);
                    return [4 /*yield*/, client.approve(contract, tokenAddress, amount, true)];
                case 16:
                    txid = _e.sent();
                    log.info("txid: ", txid);
                    //TODO let confirm
