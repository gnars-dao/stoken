...
module.exports = {
    ...
    getInfo: function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, QUEUE_NAME];
            });
        });
    },
    viewWork: function (name, max) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, redis.lrange(name, 0, max)];
            });
        });
    },
    delete: function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, redis.del(name)];
            });
        });
    },
    count: function (name) {
    ...
    createWork: function (name, work) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, redis.lpush(name, JSON.stringify(work))];
            });
        });
    },
    getWork: function (name, interval) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
