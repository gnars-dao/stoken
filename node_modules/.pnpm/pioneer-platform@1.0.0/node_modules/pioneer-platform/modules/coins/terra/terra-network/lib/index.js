...
var URL_TERRA_FCD = process.env['URL_TERRA_FCD'] || networks[0].fcd;
var URL_TERRA_MANTLE = process.env['URL_TERRA_MANTLE'] || networks[0].fcd;
var DEFAULT_NETWORK = "columbus-4";
var DEFAULT_FCD = "https://fcd.terra.dev";
var DEFAULT_MANTLE = "https://mantle.terra.dev";
var BASE_DENOM = "uluna";
var BASE_TERRA = 1000000;
/**********************************
 // Module
 //**********************************/
module.exports = {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_TERRA_FCD + '/txs/' + txid })];
                case 2:
                    txInfo = _a.sent();
...
var broadcast_transaction = function (tx, mode) {
    return __awaiter(this, void 0, void 0, function () {
        var tag, output, broadcastPayload, urlRemote, result2, logSend, e_2, e_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_TERRA_FCD + '/auth/accounts/' + address })];
                case 2:
                    txInfo = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    output = [];
                    url = URL_TERRA_FCD + '/txs?message.sender=' + address;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_TERRA_FCD + '/bank/balances/' + address })];
                case 3:
                    accountInfo = _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 5, , 6]);
                    output = {};
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_TERRA_FCD + '/syncing' })];
                case 2:
                    syncInfo = _a.sent();
                    log.info(tag, "syncInfo: ", syncInfo.data);
                    output.isSyncing = syncInfo.data;
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_TERRA_FCD + '/node_info' })];
                case 3:
                    nodeInfo = _a.sent();
                    log.debug(tag, "nodeInfo: ", nodeInfo.data);
                    output = nodeInfo.data;
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_TERRA_FCD + '/blocks/latest' })];
                case 4:
                    lastBlock = _a.sent();
