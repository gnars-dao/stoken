...
var hdPath = "m/44'/529'/0'/0/0"; //TODO get from coins
...
function createAddress(publicKey, prefix) {
    // @ts-ignore
...
module.exports = {
    generateWalletFromSeed: function (mnemonic) {
        return __awaiter(this, void 0, void 0, function () {
            var seed, mk, xpub, xpriv, publicKey, privateKey, mkAccount, xpubAccount, address, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        publicKey = bitcoin.bip32.fromBase58(xpub).publicKey;
                        privateKey = bitcoin.bip32.fromBase58(xpriv).privateKey;
                        log.debug("publicKey: ", publicKey);
                        mkAccount = new HDKey.fromMasterSeed(Buffer.from(seed, 'hex'));
                        //get master key
                        //console.log("hdPathAtom: ",hdPathAtom)
                        mkAccount = mkAccount.derive(hdPath);
                        log.debug(mkAccount.publicExtendedKey);
                        xpubAccount = mkAccount.publicExtendedKey;
                        address = createAddress(publicKey, 'secret');
