...
var URL_KAVA_LCD = process.env['URL_KAVA_LCD'] || 'https://lcd-kava.keplr.app';
var BASE_KAVA = 100000000;
/**********************************
 // Module
 //**********************************/
module.exports = {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_KAVA_LCD + '/txs/' + txid })];
                case 2:
                    txInfo = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_KAVA_LCD + '/auth/accounts/' + address })];
                case 2:
                    txInfo = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    output = [];
                    url = URL_KAVA_LCD + '/txs?message.sender=' + address;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _b.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_KAVA_LCD + '/bank/balances/' + address })];
                case 3:
                    accountInfo = _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    output = {};
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_KAVA_LCD + '/syncing' })];
                case 2:
                    syncInfo = _a.sent();
                    log.info(tag, "syncInfo: ", syncInfo.data);
                    output.isSyncing = syncInfo.data;
                    return [4 /*yield*/, axios({ method: 'GET', url: URL_KAVA_LCD + '/node_info' })];
                case 3:
                    nodeInfo = _a.sent();
