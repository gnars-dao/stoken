...
*/
var TAG = " | utxo-tx-parser | ";
var txHexDecoder = require("transaction-hex-decoder");
...
/**********************************
 // Lib
 //**********************************/
var decode_hex_to_tx = function (hex) {
    return __awaiter(this, void 0, void 0, function () {
        var tag, output, btcDecodedRawTx;
        return __generator(this, function (_a) {
            tag = TAG + " | decode_hex_to_tx | ";
            try {
                output = {};
                btcDecodedRawTx = txHexDecoder.decodeBtcRawTx(hex);
