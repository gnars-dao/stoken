...
export default {
  ...
  msg: {
    ...
    emptyPassword: 'You must provide a password.',
    unlockWallet: 'Unlock Now',
    ...
    restartApp: 'Restart App to apply settings!',
    //modal
    passwordTitle:'Enter your wallets password',
    nodeTitle:'Wallet Configuration',
    registerTitle:'Create new Username!',
    seedTitle:'your Wallets Seed!',
    sendTitle:'Send!',
    delegateTitle:'delegate your ATOMs!',
    reconfigure:'Change Runtime',
    openConfiguration:'Open connection page',
    ...
    send:{
      body:'Confirm transaction params',
      title:'Sign Transaction?'
    },

    password:{
      body:'enter your wallets password',
      title:'new password'
    },
    ...
    passwordAgain:{
      body:'Enter password again',
      title:'confirm password'
    },

    welcome:{
      continue:'Continue',
      title:'Welcome to Pioneer',
      selectLanguage:' Select your preferred language',
      welcomeNoWallet:' No previous Wallets were detected! you can: ',
      settingsAvailable:' Found a wallet already installed! Would you like to import settings?',
    ...
    login: {
      walletExist: 'Found wallet! login with original password :-)',
    },

    remove:{
      title: 'Remove Current Wallet',
      warning: 'Warning !',
      info: 'Before you remove current wallet, Make sure there is no in this wallet or You write down the Seed Phrase !',
    ...
    restore:{
      ...
      recovered: 'Wallet recovered, it is time to check balance from blockchain',
    ...
    hedwig: {
      ...
      intro2: 'When someone send to the address, Hedwig(v1) will forward the send request to your wallet. So you will get your grin.',
      start: 'Start',
      ...
      failed3: 'Failed to start local receive service, try it later maybe or restart wallet.',
      copy: 'copy address',
    ...
    check: {
      ...
      intro2: 'For this reason, provides a manual check command that scans the chain\'s UTXO set for any outputs belonging to your wallet, and ensures they\'re in a consistent state with your local wallet database.',
