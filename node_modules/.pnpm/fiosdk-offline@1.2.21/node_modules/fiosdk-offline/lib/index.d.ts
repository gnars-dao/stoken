...
import { FioActionAccount, FioActionName, FioActionData } from './entities/FioActionParameters';
/**
 * @ignore
 */
...
export declare class FIOSDK {
   ...
   * @param data JSON object with params for action
   */
    prepareTransaction(account: FioActionAccount, action: FioActionName, data: FioActionData): Promise<any>;
    /**
     * @ignore
     */
