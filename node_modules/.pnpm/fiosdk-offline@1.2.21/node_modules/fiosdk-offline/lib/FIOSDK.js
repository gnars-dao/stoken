...
exports.FioActionParameters = exports.FIOSDK = void 0;
...
class FIOSDK {
     ...
     */
    static createPrivateKeyMnemonic(mnemonic, path = 'm/44\'/235\'/0\'/0/0') {
        return __awaiter(this, void 0, void 0, function* () {
   ...
   * @param data JSON object with params for action
   */
    prepareTransaction(account, action, data) {
    ...
    genericAction(action, params) {
        switch (action) {
            ...
            case 'prepareTransaction':
                return this.prepareTransaction(params.account, params.action, params.data);
