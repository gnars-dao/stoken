...
describe("NativeBinanceWalletInfo", () => {
    ...
    it("should return some static metadata", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(yield untouchable.call(info, "binanceSupportsNetwork")).toBe(true);
        expect(yield untouchable.call(info, "binanceSupportsSecureTransfer")).toBe(false);
    }));
...
describe("NativeBinanceWallet", () => {
    ...
    it("should generate a correct binance address", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(yield wallet.binanceGetAddress({ addressNList: core.bip32ToAddressNList("m/44'/714'/0'/0/0") })).toBe("bnb1qzc0v2q7u6484czzal6ncuvqmg9fae8n2xe2c6");
    }));
    it("should generate another correct binance address", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(yield wallet.binanceGetAddress({ addressNList: core.bip32ToAddressNList("m/44'/714'/1337'/123/4") })).toBe("bnb14awl92k30hyhu36wjy6pg0trx3zlqrpfgsf3xk");
    }));
    it("should sign a transaction correctly", () => __awaiter(void 0, void 0, void 0, function* () {
        const sig = yield wallet.binanceSignTx({
            addressNList: core.bip32ToAddressNList("m/44'/714'/0'/0/0"),
            tx: {
                chain_id: "foo",
                account_number: "123",
        ...
        expect(sig === null || sig === void 0 ? void 0 : sig.signatures).toMatchInlineSnapshot(`
      Object {
    ...
    it("should sign a transaction correctly without being given an account number, sequence number, or chain id", () => __awaiter(void 0, void 0, void 0, function* () {
        const sig = yield wallet.binanceSignTx({
            addressNList: core.bip32ToAddressNList("m/44'/714'/0'/0/0"),
            tx: {
                data: null,
    ...
    it("should only handle pubkeys returned from the BNB SDK if they are in amino format", () => __awaiter(void 0, void 0, void 0, function* () {
        expect.assertions(6);
        ...
        const mock = jest
            ...
            return __awaiter(this, void 0, void 0, function* () {
                const out = yield original.apply(this, args);
        ...
        yield expect(wallet.binanceSignTx({
            addressNList: core.bip32ToAddressNList("m/44'/714'/0'/0/0"),
            tx: {
                chain_id: "foo",
                account_number: "123",
    ...
    it("should not sign an invalid transaction", () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(wallet.binanceSignTx({
            addressNList: core.bip32ToAddressNList("m/44'/714'/0'/0/0"),
            tx: {
                chain_id: "",
    ...
    it("should not sign a transaction for a non-integer amount", () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(wallet.binanceSignTx({
            addressNList: core.bip32ToAddressNList("m/44'/714'/0'/0/0"),
            tx: {
                chain_id: "foo",
    ...
    it("should not sign a transaction from a different account", () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(wallet.binanceSignTx({
            addressNList: core.bip32ToAddressNList("m/44'/714'/0'/0/0"),
            tx: {
                chain_id: "foo",
