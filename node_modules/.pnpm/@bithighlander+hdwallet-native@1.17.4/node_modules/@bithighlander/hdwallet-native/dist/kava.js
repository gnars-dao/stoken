...
function MixinNativeKavaWallet(Base) {
    var _MixinNativeKavaWallet_seed, _a;
    return _a = class MixinNativeKavaWallet extends Base {
            constructor() {
                super(...arguments);
                this._supportsKava = true;
                _MixinNativeKavaWallet_seed.set(this, void 0);
            }
            kavaInitializeWallet(seed) {
                return __awaiter(this, void 0, void 0, function* () {
                    __classPrivateFieldSet(this, _MixinNativeKavaWallet_seed, seed, "f");
                });
            }
            kavaWipe() {
                __classPrivateFieldSet(this, _MixinNativeKavaWallet_seed, undefined, "f");
            }
            ...
            kavaGetAddress(msg) {
                return __awaiter(this, void 0, void 0, function* () {
                    return this.needsMnemonic(!!__classPrivateFieldGet(this, _MixinNativeKavaWallet_seed, "f"), () => __awaiter(this, void 0, void 0, function* () {
                        return this.createKavaAddress(util_1.default.getKeyPair(__classPrivateFieldGet(this, _MixinNativeKavaWallet_seed, "f"), msg.addressNList, "kava").publicKey.toString("hex"));
                    }));
                });
            }
            kavaSignTx(msg) {
                return __awaiter(this, void 0, void 0, function* () {
                    return this.needsMnemonic(!!__classPrivateFieldGet(this, _MixinNativeKavaWallet_seed, "f"), () => __awaiter(this, void 0, void 0, function* () {
                        const keyPair = util_1.default.getKeyPair(core.mustBeDefined(__classPrivateFieldGet(this, _MixinNativeKavaWallet_seed, "f")), msg.addressNList, "kava");
        ...
        _MixinNativeKavaWallet_seed = new WeakMap(),
        _a;
}
