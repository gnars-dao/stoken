...
describe("NativeSecretWalletInfo", () => {
    ...
    it("should return some static metadata", () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(untouchable.call(info, "secretSupportsNetwork")).resolves.toBe(true);
        yield expect(untouchable.call(info, "secretSupportsSecureTransfer")).resolves.toBe(false);
    }));
...
describe("NativeSecretWallet", () => {
    ...
    it("should generate a correct secret address", () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(wallet.secretGetAddress({ addressNList: core.bip32ToAddressNList("m/44'/529'/0'/0/0") })).resolves.toBe("secret189wrfk2fsynjlz6jcn54wzdcud3a6k8vqa0ggu");
    }));
    it("should generate another correct secret address", () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(wallet.secretGetAddress({ addressNList: core.bip32ToAddressNList("m/44'/529'/1337'/123/4") })).resolves.toBe("secret1wmmewcjt2s09r48ya8mtdfyy0rnnza20xnx6fs");
    }));
    it("should signing transactions", () => __awaiter(void 0, void 0, void 0, function* () {
        const signed = yield wallet.secretSignTx({
        ...
        expect(signed.signatures[0].signature).toMatchInlineSnapshot(`"f4HKv09XvsGQn74y4MHL+M+wP/uBjHsIn5PwPfq7xMI7CJkS22Pxx7KlXpeUzCjiaSZvEEIuxbkd9J+Q4g86jg=="`);
    }));
});
