...
const mswMock = require("mswMock")({
    ...
    post: {
        "https://fio.eu.eosamsterdam.net/v1/chain/get_block": {
            ...
            new_producers: null,
            header_extensions: [],
            producer_signature: "SIG_K1_KAJ9KUhQ94GWqPGmZ13rzHYbaR7kB3f4xaK73G24EEU82fMjboJTtBxZWk65Qdcy3iQimgeJ6bUWaSsU7kmmMMMFwb2fmR",
            transactions: [],
            block_extensions: [],
        ...
        "https://fio.eu.eosamsterdam.net/v1/chain/get_pub_address": (body) => {
...
describe("NativeFioWalletInfo", () => {
    ...
    it("should return some static metadata", () => __awaiter(void 0, void 0, void 0, function* () {
        expect(yield untouchable.call(info, "fioSupportsNetwork")).toBe(true);
        expect(yield untouchable.call(info, "fioSupportsSecureTransfer")).toBe(false);
    }));
...
describe("NativeFioWallet", () => {
    ...
    describe("stuff that uses the network", () => {
        ...
        it("should generate a correct FIO address", () => __awaiter(void 0, void 0, void 0, function* () {
            const address = yield wallet.fioGetAddress({ addressNList: core.bip32ToAddressNList("m/44'/235'/0'/0/0") });
            expect(address).toBe("FIO5NSKecB4CcMpUxtpHzG4u43SmcGMAjRbxyG38rE4HPegGpaHu9");
        }));
        it("should generate another correct FIO address", () => __awaiter(void 0, void 0, void 0, function* () {
            const address = yield wallet.fioGetAddress({ addressNList: core.bip32ToAddressNList("m/44'/235'/1337'/123/4") });
            expect(address).toBe("FIO8Pok1EBMsZWphhfUj2m3MXrxBZJq7erqyi7E1teAfZE18HyjK5");
        }));
        it("should generate another correct FIO address", () => __awaiter(void 0, void 0, void 0, function* () {
            const address = yield wallet.fioGetAddress({ addressNList: core.bip32ToAddressNList("m/44'/235'/1'/0/0") });
            expect(address).toMatchInlineSnapshot(`"FIO8HiUzsRDYo69AEmUk39f7h7nawTjn9msbX6oUY5wrX6ERCh3rA"`);
        }));
        it("should expose the FIO SDK", () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield wallet.getFioSdk(core.bip32ToAddressNList("m/44'/235'/0'/0/0"))).toBeInstanceOf(fio.FIOSDK);
        }));
        it("should sign a message", () => __awaiter(void 0, void 0, void 0, function* () {
            const sig = yield wallet.fioSignTx({
      ...
      `);
            ...
            const chainId = Buffer.from(mswMock.handlers.get["https://fio.eu.eosamsterdam.net/v1/chain/get_info"].chain_id, "hex");
        ...
        it("should encrypt a request", () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield wallet.fioEncryptRequestContent({
                addressNList: core.bip32ToAddressNList("m/44'/235'/0'/0/0"),
                content: {
            ...
            })).toMatchInlineSnapshot(`"3q2+796tvu/erb7v3q2+7yeNoq+0I2pI2M5ylVEBuYkKwwHIJfKeuDZPp9bOLZNVbGtY7bfy/U9b7n316iuX1EQJHlIiHLOELx60jdWfF4A67x1T3WR8OW6lGBYCZDj8j50YbQM/oqcAIG5ND9MWK9U6Z2rcubAuZvQAcll1Jm4cIgVp49+ZxSKzEvH7Aasz"`);
        }));
        it("should decrypt a request", () => __awaiter(void 0, void 0, void 0, function* () {
            expect(yield wallet.fioDecryptRequestContent({
                addressNList: core.bip32ToAddressNList("m/44'/235'/1'/0/0"),
                content: "3q2+796tvu/erb7v3q2+7yeNoq+0I2pI2M5ylVEBuYkKwwHIJfKeuDZPp9bOLZNVbGtY7bfy/U9b7n316iuX1EQJHlIiHLOELx60jdWfF4A67x1T3WR8OW6lGBYCZDj8j50YbQM/oqcAIG5ND9MWK9U6Z2rcubAuZvQAcll1Jm4cIgVp49+ZxSKzEvH7Aasz",
...
//# sourceMappingURL=fio.test.js.map