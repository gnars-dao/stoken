...
import { deriveChildKey as sharedDeriveChildKey, deriveSecretExtension, generateEntropy, derivePublicExtension } from './shared';
/**
 ...
 */ export function publicKeyToEthAddress(key) {
    assert(key instanceof Uint8Array && isValidBytesKey(key, secp256k1.publicKeyLength), 'Invalid key: The key must be a 65-byte, non-zero Uint8Array.');
