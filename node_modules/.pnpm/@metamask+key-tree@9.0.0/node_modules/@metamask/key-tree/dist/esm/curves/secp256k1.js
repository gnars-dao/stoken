...
import { getPublicKey as getSecp256k1PublicKey, Point, utils } from '@noble/secp256k1';
...
export const getPublicKey = (privateKey, compressed)=>getSecp256k1PublicKey(privateKey, compressed);
