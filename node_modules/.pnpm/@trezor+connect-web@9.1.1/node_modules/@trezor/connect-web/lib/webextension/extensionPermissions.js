...
const sendMessage = (message, origin) => window.parent.postMessage(message, origin);
exports.sendMessage = sendMessage;
const onLoad = () => {
    (0, exports.sendMessage)('usb-permissions-init', '*');
};
const init = (label) => {
    ...
    usbButton.onclick = async () => {
        ...
        if (usb) {
            try {
                ...
                (0, exports.sendMessage)('usb-permissions-close', '*');
            }
            catch (error) {
            }
        }
