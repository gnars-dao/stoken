                ...
                it('signs a mainnet ' + asset + ' reference transfer transaction', function () {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    referenceTx = fs.readFileSync('./src/reference-data/tx01.mainnet.' + asset + '.json');
                                    referenceTx = JSON.parse(referenceTx.toString());
                                    referenceTxSigned = fs.readFileSync('./src/reference-data/tx01.mainnet.' + asset + '.signed.json');
