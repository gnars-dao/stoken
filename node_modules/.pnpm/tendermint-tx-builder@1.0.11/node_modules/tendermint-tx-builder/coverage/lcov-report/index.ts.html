...
export async function createSignedTx(tx: any, signature: any) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if(!tx.signatures) tx.signatures = []
...
&nbsp;
        ...
        const fee:any = {
            amount: jsonTx.fee.amount || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
            gas: jsonTx.fee.gas
        }
&nbsp;
...
&nbsp;
    ...
    Object.keys(jsonTx)
        .sort()
        .forEach(key =&gt; {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (jsonTx[key] === undefined || jsonTx[key] === null) <span class="cstat-no" title="statement not covered" >return</span>
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu May 13 2021 10:56:06 GMT-0600 (Mountain Daylight Time)
            </div>
        </div>
