import { CosmosTransaction, EvmTransaction, SimulationResult, SolanaTransaction, SwapperStatusStep, Transfer as TransferTransaction } from '../api/main/index.js';
import { AmountRestrictionType, StarknetTransaction, SwapExplorerUrl, TronTransaction, TonTransaction } from '../api/shared/index.js';
...
export type PendingSwapStep = SwapStepRoute & SwapStepTransaction & SwapStepStatus & {
    id: number;
