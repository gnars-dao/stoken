import { TransactionType, GenericTransactionType, SwapExplorerUrl, ReportTransactionRequest, TransactionStatus, CheckApprovalResponse, CosmosTransaction, Transfer, SolanaTransaction, TronTransaction, StarknetTransaction, TonTransaction } from '../shared/index.js';
import { EvmTransaction } from './txs/index.js';
export { TransactionType, GenericTransactionType, SwapExplorerUrl, ReportTransactionRequest, TransactionStatus, CheckApprovalResponse, };
/**
 ...
 */
export type Transaction = EvmTransaction | CosmosTransaction | SolanaTransaction | TronTransaction | StarknetTransaction | TonTransaction | Transfer;
/**
