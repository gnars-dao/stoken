...
const erc20_1 = __importDefault(require("../../parser/abi/erc20"));
const uniV2_1 = __importDefault(require("./abi/uniV2"));
const uniV2StakingRewards_1 = __importDefault(require("./abi/uniV2StakingRewards"));
const constants_1 = require("./constants");
class Parser {
    constructor(args) {
        this.abiInterface = new ethers_1.ethers.utils.Interface(uniV2_1.default);
        this.stakingRewardsInterface = new ethers_1.ethers.utils.Interface(uniV2StakingRewards_1.default);
        ...
        const transfers = await (async () => {
            switch ((0, parser_1.getSigHash)(tx.inputData)) {
                case this.supportedFunctions.addLiquidityEthSigHash: {
                    const contract = new ethers_1.ethers.Contract(tokenAddress, erc20_1.default, this.provider);
                ...
                case this.supportedFunctions.removeLiquidityEthSigHash: {
                    const contract = new ethers_1.ethers.Contract(lpTokenAddress, erc20_1.default, this.provider);
                    const decimals = await contract.decimals();
                    const name = await contract.name();
                    const symbol = await contract.symbol();
    ...
    async parse(tx) {
        ...
        if (constants_1.UNI_V2_FOX_STAKING_REWARDS_CONTRACTS.some((contract) => (0, parser_1.txInteractsWithContract)(tx, contract)))
