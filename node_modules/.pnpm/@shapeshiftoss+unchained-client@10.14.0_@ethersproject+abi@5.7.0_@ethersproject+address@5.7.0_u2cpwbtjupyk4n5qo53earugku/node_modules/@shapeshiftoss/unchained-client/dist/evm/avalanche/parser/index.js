...
exports.TransactionParser = exports.ZRX_AVALANCHE_PROXY_CONTRACT = void 0;
const caip_1 = require("@shapeshiftoss/caip");
const parser_1 = require("../../parser");
const erc20 = __importStar(require("../../parser/erc20"));
const zrx = __importStar(require("../../parser/zrx"));
exports.ZRX_AVALANCHE_PROXY_CONTRACT = '0xDef1C0ded9bec7F1a1670819833240f027b25EfF';
class TransactionParser extends parser_1.BaseTransactionParser {
    constructor(args) {
        super(args);
        this.assetId = caip_1.avalancheAssetId;
        this.registerParsers([
            new erc20.Parser({ chainId: this.chainId, provider: this.provider }),
            new zrx.Parser({ proxyContract: exports.ZRX_AVALANCHE_PROXY_CONTRACT }),
        ]);
    }
}
