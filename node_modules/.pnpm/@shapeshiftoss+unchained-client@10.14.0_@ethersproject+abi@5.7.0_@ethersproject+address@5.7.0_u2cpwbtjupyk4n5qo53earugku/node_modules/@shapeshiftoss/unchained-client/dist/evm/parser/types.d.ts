...
export declare type TxMetadata = bep20.TxMetadata | cowswap.TxMetadata | erc20.TxMetadata | foxy.TxMetadata | thor.TxMetadata | uniV2.TxMetadata | weth.TxMetadata | yearn.TxMetadata | zrx.TxMetadata;
export interface ParsedTx extends StandardTx {
    data?: TxMetadata;
}
export declare type TxSpecific = Partial<Pick<ParsedTx, 'trade' | 'transfers' | 'data'>>;
