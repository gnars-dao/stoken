    ...
    async parse(tx) {
        ...
        if (!this.yearnTokenVaultAddresses) {
            try {
                ...
                this.yearnTokenVaultAddresses = data === null || data === void 0 ? void 0 : data.map((vault) => vault.address);
            }
            catch (e) {
        ...
        switch (txSigHash) {
            ...
            case this.supportedYearnFunctions.depositAmountAndRecipientSigHash:
                if (tx.to && !((_a = this.yearnTokenVaultAddresses) === null || _a === void 0 ? void 0 : _a.includes(tx.to)))
                    return;
                return { data };
