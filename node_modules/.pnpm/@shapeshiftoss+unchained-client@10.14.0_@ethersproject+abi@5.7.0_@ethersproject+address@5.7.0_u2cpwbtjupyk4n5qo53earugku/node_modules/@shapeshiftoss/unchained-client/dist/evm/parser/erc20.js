...
class Parser {
    constructor(args) {
        this.abiInterface = new ethers_1.ethers.utils.Interface(erc20_1.default);
    ...
    async parse(tx) {
        ...
        switch (txSigHash) {
            case this.supportedFunctions.approveSigHash: {
                const value = decoded.args.amount;
                if (value.isZero())
                    return { data: { ...data, method: 'revoke', value: value.toString() } };
