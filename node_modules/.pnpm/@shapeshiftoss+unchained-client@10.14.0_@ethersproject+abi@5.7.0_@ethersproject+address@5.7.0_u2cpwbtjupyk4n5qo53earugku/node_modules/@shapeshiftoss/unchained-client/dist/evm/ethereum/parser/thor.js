...
const thorAvalanche_1 = __importDefault(require("./abi/thorAvalanche"));
const thorEthereum_1 = __importDefault(require("./abi/thorEthereum"));
...
class Parser {
        ...
        this.abiInterface = (() => {
            switch (args.chainId) {
                case caip_1.ethChainId:
                    return new ethers_1.ethers.utils.Interface(thorEthereum_1.default);
                case caip_1.avalancheChainId:
                    return new ethers_1.ethers.utils.Interface(thorAvalanche_1.default);
                default:
    ...
    async parse(tx) {
        ...
        if (SWAP_TYPES.includes(type) || type === 'OUT') {
            return { trade: { dexName: types_1.Dex.Thor, type: types_1.TradeType.Trade, memo: decoded.args.memo }, data };
        }
        if (type === 'REFUND') {
            return { trade: { dexName: types_1.Dex.Thor, type: types_1.TradeType.Refund, memo: decoded.args.memo }, data };
        }
