...
class V1Api extends runtime.BaseAPI {
    ...
    async estimateGasRaw(requestParameters, initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OptimismGasEstimateFromJSON)(jsonValue));
    }
    /**
     * Get the estimated gas cost of a transaction
     */
    ...
    async getGasFeesRaw(initOverrides) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => (0, models_1.OptimismGasFeesFromJSON)(jsonValue));
    }
    /**
     * Get the current recommended gas fees to use in a transaction  * `l1GasPrice` = l1BaseFee * scalar
     */
