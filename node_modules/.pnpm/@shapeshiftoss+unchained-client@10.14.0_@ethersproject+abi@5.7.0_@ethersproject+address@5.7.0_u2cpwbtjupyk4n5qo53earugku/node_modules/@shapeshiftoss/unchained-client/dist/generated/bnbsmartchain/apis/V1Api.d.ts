...
import type { Account, BaseInfo, BaseTxHistoryTx, GasEstimate, GasFees, SendTxBody, Tx } from '../models';
...
export declare class V1Api extends runtime.BaseAPI {
     ...
     */
    estimateGasRaw(requestParameters: EstimateGasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GasEstimate>>;
    /**
     * Get the estimated gas cost of a transaction
     */
    estimateGas(requestParameters: EstimateGasRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GasEstimate>;
    /**
     ...
     */
    getGasFeesRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GasFees>>;
    /**
     * Get the current recommended gas fees to use in a transaction
     */
    getGasFees(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GasFees>;
    /**
