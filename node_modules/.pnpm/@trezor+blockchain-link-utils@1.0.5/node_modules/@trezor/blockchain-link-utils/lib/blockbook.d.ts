...
export declare const filterEthereumInternalTransfers: (address: string, ethereumSpecific: BlockbookTransaction['ethereumSpecific']) => InternalTransfer[];
...
export declare const transformTransaction: (descriptor: string, addresses: TransformAddresses | undefined, tx: BlockbookTransaction) => Transaction;
